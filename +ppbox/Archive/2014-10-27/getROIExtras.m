...
%   for zoomFactor 2 we have 500um field of view, scale accordingly    
    xCentreMicrons = xCentrePixels/scanPixelsPerLine/scanZoomFactor*1000; 
    yCentreMicrons = yCentrePixels/scanLinesPerFrame/scanZoomFactor*1000; 
...
for iROI = 1:length(infoROI.targetFrameROI)
    ...
    infoOut.ROI.CellXYZMicrons{iROI}(3) = 40*(interp1(1:scanLinesPerFrame, thisPlaneZ, infoOut.ROI.CellXYPixels{iROI}(2))-10);
end
