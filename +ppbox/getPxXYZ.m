function [micronsX, micronsY, micronsZ, xMicronsPerPixel, yMicronsPerPixel] = getPxXYZ(info)
...
if isfield(info, 'microID')
    [fovx, fovy] = ppbox.zoom2fov(scanZoomFactor, infoROI.microID, info.expDate);
else
    [fovx, fovy] = ppbox.zoom2fov(scanZoomFactor, [], info.expDate);
end
